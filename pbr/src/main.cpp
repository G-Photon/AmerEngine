...
int main()
{
    ...
    // -------------------------
    Shader pbrShader(PATH "shader/pbr.vs", PATH "shader/pbr4.fs");
    Shader equirectangularToCubemapShader(PATH "shader/cubemap.vs", PATH "shader/equirectangular_to_cubemap.fs");
    Shader irradianceShader(PATH "shader/cubemap.vs", PATH "shader/irradiance_convolution.fs");
    Shader prefilterShader(PATH "shader/cubemap.vs", PATH "shader/prefilter.fs");
    Shader brdfShader(PATH "shader/brdf.vs", PATH "shader/brdf.fs");
    Shader backgroundShader(PATH "shader/background.vs", PATH "shader/background.fs");
    ...
    float *data = stbi_loadf(PATH "resources/textures/hdr/newport_loft.hdr", &width, &height,
                             &nrComponents, 0);
